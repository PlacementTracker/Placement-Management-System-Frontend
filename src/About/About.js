...
const About = () => {
  return (
    <div className="about-us">
      ...
      />
      <div className="ahitagni-pai">Ahitagni Pai</div>
      <div className="barenya-nandi">Barenya Nandi</div>
      <div className="shalini-kumari">Shalini Kumari</div>
      <div className="sayak-maity">Sayak Maity</div>
