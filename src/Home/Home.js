  ...
  return (
    <div className="desktop-1">
     ...
     <div className="hero-section">
      <img src="images/NSEC_Logo.png" alt="" />
      ...
      <div className="about">
        ...
        <div className="text1">-Training and Placement cell </div>
</div>
     </div>
     ...
     <div className="footer"> Developed by internal team @NSEC as a Final Year Project , 2023</div>
    </div>
  );
};
